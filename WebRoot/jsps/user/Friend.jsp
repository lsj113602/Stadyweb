  ...
  <body>
	...
	<div class="zhuye-banner">
		<div class="midd-banner">
			...
			<h1>好友昵称：${sessionScope.sessionUser.user_name }</h1>
		</div>
	</div>
	<!-- banner结束 -->
	<!-- 主页内容盒子 -->
	<div class="zhuye-box">
		<div class="left-zhuye">
			<div class="left-zhuye-nav">
				<ul>
					<li><a class="current" href="/Stadyweb/jsps/user/zhuye.jsp"><i class="iconfont">&#xe651;</i>好友主页</a></li>
					<li><a href="/Stadyweb/jsps/user/zhuye_class.jsp"><i class="iconfont">&#xe693;</i>好友课程</a></li>
					<li><a href="/Stadyweb/jsps/user/zhuye_answer.jsp"><i class="iconfont">&#xe66c;</i>好友问答</a></li>
					<li><a href="/Stadyweb/jsps/user/zhuye_text.jsp"><i class="iconfont">&#xe628;</i>好友文章</a></li>
					<li><a href="<c:url value='/Servlet?method=FindMyVideo'/>"><i class="iconfont">&#xe607;</i>好友视频</a></li>
					<li><a href="/Stadyweb/jsps/user/zhuye_ji.jsp"><i class="iconfont">&#xe60b;</i>好友统计</a></li>
					<li><a href="/Stadyweb/jsps/user/FriendsList.jsp"><i class="iconfont">&#xe693;</i>好友关注</a></li>
				</ul>
			</div>
		</div>
