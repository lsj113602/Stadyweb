		...
		<div class="left-zhuye">
			<div class="left-zhuye-nav">
				<ul>
					...
					<li><a href="/Stadyweb/jsps/user/zhuye_text.jsp"><i class="iconfont">&#xe628;</i>文章</a></li>
					...
					<li><a href="/Stadyweb/jsps/user/friends.jsp"><i class="iconfont">&#xe693;</i>好友</a></li>
				</ul>
			</div>
		</div>
			...
			<div class="zhuye-main">
				<div class="first">
					...
					<div class="first-right">
						<a href="/Stadyweb/jsps/user/Friend.jsp">王莫某</a>
