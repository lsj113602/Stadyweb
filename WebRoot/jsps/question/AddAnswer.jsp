  ...
  <body>
	...
	<div class="tiwenbox">
		<div class="left-tiwen">
			<h1>回答</h1>
			<form action="<c:url value='/QuesAnswerServlet'/>" method="post">
			<input type="hidden" name="method" value="AddAnswer"/>
			<input type="hidden" name="quesid" value="${requestScope.quesid}"/>
			
			<textarea  name="qatext" cols="80" rows="1" class="area" placeholder="请一句话说明你的问题，已问号结尾。"></textarea>
