    ...
    <div class="row">
        <div class="col-md-2" style="text-align: center">
            <ul class="nav nav-pills nav-stacked">
                ...
                <hr> -->
                <li style="height: 30px" role="presentation"  class="active"><a href="/Stadyweb/newjsps/user/myscores.jsp"><i class="glyphicon glyphicon-pushpin"></i> 考试记录</a></li>
            </ul>
        </div>
        <div class="col-md-10">
            <div>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home">
                          ...
                          <%@include file="/newjsps/table/table.jsp" %>        
...
<script src="../../js/bootstrap.min.js"></script>
    ...
    <script src="../assets/js/custom-scripts.js"></script>
     <!-- jQuery Js -->
    <script src="../table/assets/js/jquery-1.10.2.js"></script>
      <!-- Bootstrap Js -->
    <script src="../table/assets/js/bootstrap.min.js"></script>
    <!-- Metis Menu Js -->
    <script src="../table/assets/js/jquery.metisMenu.js"></script>
     <!-- DATA TABLE SCRIPTS -->
    <script src="../table/assets/js/dataTables/jquery.dataTables.js"></script>
    <script src="../table/assets/js/dataTables/dataTables.bootstrap.js"></script>
