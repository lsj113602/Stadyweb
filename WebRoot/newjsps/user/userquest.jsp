    ...
    <div class="row">
        <div class="col-md-2" style="text-align: center">
            <ul class="nav nav-pills nav-stacked">
                <li style="height: 30px" role="presentation" ><a href="/Stadyweb/newjsps/user/mycenter.jsp"><i class="glyphicon glyphicon-home"></i> 个人主页</a></li>
                <hr>
                ...
                <hr>
                <li style="height: 30px" role="presentation"><a href="/Stadyweb/newjsps/user/myplan.jsp"><i class="glyphicon glyphicon-flag"></i> 我的计划</a></li>
                <hr>
                <li style="height: 30px" role="presentation" class="active"><a href="#"><i class="glyphicon glyphicon-globe"></i> 个人问答</a></li>
                <hr>
            ...
            <div>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home">
                            ...
                            <%@include file="/newjsps/user/fullcalendar.jsp" %>                 
