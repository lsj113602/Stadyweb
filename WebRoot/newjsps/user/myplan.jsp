    ...
    <div class="row">
        <div class="col-md-2" style="text-align: center">
            <ul class="nav nav-pills nav-stacked">
                ...
                <hr> -->
                <li style="height: 30px" role="presentation" class="active"><a href="<c:url value='/PlanServlet?method=FindplanByall'/>"><i class="glyphicon glyphicon-flag"></i> 我的计划</a></li>
                <hr>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="profile">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form class="form-inline" action="<c:url value='/PlanServlet?method=AddPlan'/>" method="POST">
                                    ...
                                    <select name="blongid" id="blongid" style="width: 100%" class="form-control">
                                        ...
                                        <option value="${pplan.planid}">${pplan.plantext}</option>
                                        </c:forEach>                
                                    </select>
                                    <div style="height: 20px"></div>
